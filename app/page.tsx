...
import todailogo from "@/public/todai-logo.png";
...
export default function LoginForm() {
  return (
    <main className="bg-gradient-to-r from-sky-200 to-orange-200h-full min-h-screen">
        ...
        <div className="max-width flex items-center justify-center lg:justify-between">
          <Link className="flex items-center gap-1" href="/loggedin">
            <Image
              ...
              height="50"
              alt="logo"
              className="h-16 w-24 md:h-16 md:w-24"
            />
          </Link>
        ...
        <footer className="bottom-0 container mx-auto my-5 flex flex-col items-center justify-between space-y-3 border-t space-x-4 px-3 pt-4 text-center sm:flex-row sm:pt-2 md:text-lg">
          ...
          <div className="flex space-x-4 pb-4 sm:pb-0">
            ...
            <a
              className="group"
              aria-label="GitHub"
              href="https://github.com/Sdem15211/Todai"
            >
              <svg
                aria-hidden="true"
...
function GetStartedButton() {
  ...
  return (
    <button
      disabled={pending}
      type="submit"
      className="flex items-center justify-center px-8 py-4 mb-2 me-2 overflow-hidden text-xl font-medium text-gray-100 rounded-xl group bg-gradient-to-br from-blue-600 to-purple-600 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-yellow-300 dark:focus:ring-blue-800"
    >
